        ...
        <div class="card-body">
            ...
            <div class="" style="border-bottom-width :3px; border-bottom-style: solid; border-bottom-color:black;">
                <div class="ml-4 mt-3">
                    <p>Ketua (Penulis) :
                        &nbsp
                        <a href="{{secure_url('/pkm/ketua')}}/<?php echo $data->id ?>">EDIT &nbsp<i class="fas fa-pencil-alt fa-sm text-white-10"></i></a>
                        </p>
                    ...
                    <p>Staff Dosen :
                        &nbsp
                        <a href="{{secure_url('/pkm/staff')}}/<?php echo $data->id ?>">EDIT &nbsp<i class="fas fa-pencil-alt fa-sm text-white-10"></i></a>
                    </p>
                    <div class="table-responsive">
                        <table class="table table-border">
                            <thead>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a class="btn btn-primary" href="{{secure_url('/del_pkm')}}/{{$data->id}}/<?php echo $staff->id ?>">YES</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <p>Mahasiswa :
                        &nbsp
                        <a href="{{secure_url('/pkm/mhs')}}/<?php echo $data->id ?>">EDIT &nbsp<i class="fas fa-pencil-alt fa-sm text-white-10"></i></a>
                    </p>
                        <div class="table-responsive">
                            <table class="table table-border">
                                <thead>
                                            ...
                                            <div class="modal fade" id="modalmhs<?php echo $mhs->id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                                                            <a class="btn btn-primary" href="{{secure_url('/del_pkm')}}/{{$data->id}}/<?php echo $mhs->id ?>">YES</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <p>Alumni :
                        &nbsp
                        <a href="{{secure_url('/pkm/alm')}}/<?php echo $data->id ?>">EDIT &nbsp<i class="fas fa-pencil-alt fa-sm text-white-10"></i></a>
                    </p>
                        <div class="table-responsive">
                            <table class="table table-border">
                                <thead>
                                        ...
                                        <div class="modal fade" id="modalalm<?php echo $alm->id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                                                        <a class="btn btn-primary" href="{{secure_url('/del_pkm')}}/{{$data->id}}/<?php echo $alm->id ?>">YES</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="ml-2 mt-3">
                <h3>Mitra</h3>
                <a href="{{secure_url('/pkm/mitra')}}/<?php echo $data->id ?>">EDIT &nbsp<i class="fas fa-pencil-alt fa-sm text-white-10"></i></a>
            </div>
            <div class="" style="border-bottom-width :3px; border-bottom-style: solid; border-bottom-color:black;">
                <div class="table-responsive">
                    <div class="ml-4 mt-3">
                                    ...
                                    <div class="modal fade" id="modalmitra<?php echo $mitra->id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                                                    <a class="btn btn-primary" href="{{secure_url('/del_pkm/mitra')}}/{{$data->id}}/<?php echo $mitra->id ?>">YES</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div style="border-bottom-width :3px; border-bottom-style: solid; border-bottom-color:black;">
                <div class="ml-4 mt-3">
                    <p>Iptek Lainnya :
                        &nbsp
                        <a href="{{secure_url('/pkm/luaran/ipteklain')}}/<?php echo $data->id ?>">EDIT &nbsp<i class="fas fa-pencil-alt fa-sm text-white-10"></i></a>
                    </p>
                    <div class="table-responsive">
                        <table class="table table-border">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($luaran['ipteklain'][$key]->bukti !=NULL)
                                            <a href="{{secure_url('/iptek_down')}}/{{$value->id}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                                                <i class="fas fa-download fa-sm text-white-50"></i>
                                            Download</a>
                                            <a href="{{secure_url('/iptek_file')}}/{{$value->id}}"  target="_blank"class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                                    ...
                                    <div class="modal fade" id="modaliptek<?php echo $luaran['ipteklain'][$key]->id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                                                    <a class="btn btn-primary" href="{{secure_url('/del_pkm/iptek/')}}{{$data->id}}/<?php echo $luaran['ipteklain'][$key]->id ?>">YES</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="ml-4 mt-3">
                    <p>Haki :
                        &nbsp
                        <a href="{{secure_url('/pkm/luaran/haki')}}/<?php echo $data->id ?>">EDIT &nbsp<i class="fas fa-pencil-alt fa-sm text-white-10"></i></a>
                    </p>
                    <div class="table-responsive">
                        <table class="table table-border">
                            <thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$luaran['haki'][$key]->status}}</td>
                                     <td>
                                        @if($luaran['haki'][$key]->bukti !=NULL)
                                            <a href="{{secure_url('/haki_down/')}}{{$value->id}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                                                <i class="fas fa-download fa-sm text-white-50"></i>
                                            Download</a>
                                            <a href="{{secure_url('/haki_file')}}/{{$value->id}}" target="_blank" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                                                <i class="fas fa-eye fa-sm text-white-50"></i>
                                            Show</a>
                                        @else
                                           Tidak Ada File
                                    ...
                                    <div class="modal fade" id="modalhaki<?php echo $luaran['haki'][$key]->id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                                                    <a class="btn btn-primary" href="{{secure_url('/del_pkm/haki')}}/{{$data->id}}/<?php echo $luaran['haki'][$key]->id ?>">YES</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="ml-4 mt-3">
                    <p>Produk Tersertifikasi :
                        &nbsp
                        <a href="{{secure_url('/pkm/luaran/prodser')}}/<?php echo $data->id ?>">EDIT &nbsp<i class="fas fa-pencil-alt fa-sm text-white-10"></i></a>
                    </p>
                    <div class="table-responsive">
                        <table class="table table-border">
                            <thead>
                                    ...
                                    <td>{{$luaran['prod_sertif'][$key]->no_keputusan}}</td>
                                     <td>
                                        @if($luaran['prod_sertif'][$key]->bukti !=NULL)
                                            <a href="{{secure_url('/sertif_down')}}/{{$value->id}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                                                <i class="fas fa-download fa-sm text-white-50"></i>
                                            Download</a>
                                            <a href="{{secure_url('/sertif_file')}}/{{$value->id}}" target="_blank" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                                                <i class="fas fa-eye fa-sm text-white-50"></i>
                                            Show</a>
                                        @else
                                           Tidak Ada File
                                    ...
                                    <div class="modal fade" id="modalprodser<?php echo $luaran['prod_sertif'][$key]->id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                                                    <a class="btn btn-primary" href="{{secure_url('/del_pkm/prodser')}}/{{$data->id}}/<?php echo $luaran['prod_sertif'][$key]->id ?>">YES</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="ml-4 mt-3">
                    <p>Produk Terstandarisasi :
                        &nbsp
                        <a href="{{secure_url('/pkm/luaran/prodstan')}}/<?php echo $data->id ?>">EDIT &nbsp<i class="fas fa-pencil-alt fa-sm text-white-10"></i></a>
                    </p>
                    <div class="table-responsive">
                        <table class="table table-border">
                            <thead>
                                    ...
                                    <td>{{$luaran['prod_standar'][$key]->no_keputusan}}</td>
                                     <td>
                                        @if($luaran['prod_standar'][$key]->bukti !=NULL)
                                            <a href="{{secure_url('/standar_down')}}/{{$value->id}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                                                <i class="fas fa-download fa-sm text-white-50"></i>
                                            Download</a>
                                            <a href="{{secure_url('/standar_file')}}/{{$value->id}}" target="_blank" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                                                <i class="fas fa-eye fa-sm text-white-50"></i>
                                            Show</a>
                                        @else
                                           Tidak Ada File
                                    ...
                                    <div class="modal fade" id="modalprodstan<?php echo $luaran['prod_standar'][$key]->id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                                                    <a class="btn btn-primary" href="{{secure_url('/del_pkm/prodstan')}}/{{$data->id}}/<?php echo $luaran['prod_standar'][$key]->id ?>">YES</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="ml-4 mt-3">
                    <p>Buku :
                        &nbsp
                        <a href="{{secure_url('/pkm/luaran/buku')}}/<?php echo $data->id ?>">EDIT &nbsp<i class="fas fa-pencil-alt fa-sm text-white-10"></i></a>
                    </p>
                    <div class="table-responsive">
                        <table class="table table-border">
                            <thead>
                                    ...
                                    <td>{{$luaran['buku'][$key]->jum_halaman}}</td>
                                     <td>
                                        @if($luaran['buku'][$key]->bukti !=NULL)
                                            <a href="{{secure_url('/buku_down')}}/{{$value->id}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                                                <i class="fas fa-download fa-sm text-white-50"></i>
                                            Download</a>
                                            <a href="{{secure_url('/buku_file')}}/{{$value->id}}" target="_blank" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                                                <i class="fas fa-eye fa-sm text-white-50"></i>
                                            Show</a>
                                        @else
                                           Tidak Ada File
                                    ...
                                    <div class="modal fade" id="modalbuku<?php echo $luaran['buku'][$key]->id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                                                    <a class="btn btn-primary" href="{{secure_url('/del_pkm/buku/{{$data->id}}')}}/<?php echo $luaran['buku'][$key]->id ?>">YES</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="ml-4 mt-3">
                    <p>Mitra Berbadan Hukum :
                        &nbsp
                        <a href="{{secure_url('/pkm/luaran/mitrahukum')}}/<?php echo $data->id ?>">EDIT &nbsp<i class="fas fa-pencil-alt fa-sm text-white-10"></i></a>
                    </p>
                    <div class="table-responsive">
                        <table class="table table-border">
                            <thead>
                                    ...
                                    <td>{{$luaran['mbh'][$key]->bidang_usaha}}</td>
                                     <td>
                                        @if($luaran['mbh'][$key]->bukti !=NULL)
                                            <a href="{{secure_url('/mbh_down')}}/{{$value->id}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                                                <i class="fas fa-download fa-sm text-white-50"></i>
                                            Download</a>
                                            <a href="{{secure_url('/mbh_file')}}/{{$value->id}}" target="_blank" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                                                <i class="fas fa-eye fa-sm text-white-50"></i>
                                            Show</a>
                                        @else
                                           Tidak Ada File
                                    ...
                                    <div class="modal fade" id="modalmbh<?php echo $luaran['mbh'][$key]->id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                                                    <a class="btn btn-primary" href="{{secure_url('/del_pkm/mitrahukum')}}/{{$data->id}}/<?php echo $luaran['mbh'][$key]->id ?>">YES</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="ml-4 mt-3">
                    <p>Pemakalah di Forum Ilmiah :
                        &nbsp
                        <a href="{{secure_url('/pkm/luaran/forum')}}/<?php echo $data->id ?>">EDIT &nbsp<i class="fas fa-pencil-alt fa-sm text-white-10"></i></a>
                    </p>
                    <div class="table-responsive">
                        <table class="table table-border">
                            <thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @foreach($luaran['penulismakalah'] as $key=>$values)
                                        <p>
                                            {{$values->nidn}} - {{$values->nama}}
                                        </p>
                                        @endforeach
                                    </td>
                                    ...
                                    <td>{{$value->dari}} - {{$value->sampai}}</td>
                                    <td>{{$value->tempat}}</td>
                                     <td>
                                        @if($value->bukti !=NULL)
                                            <a href="{{secure_url('/forum_down')}}/{{$value->id}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                                                <i class="fas fa-download fa-sm text-white-50"></i>
                                            Download</a>
                                            <a href="{{secure_url('/forum_file')}}/{{$value->id}}" target="_blank" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                                                <i class="fas fa-eye fa-sm text-white-50"></i>
                                            Show</a>
                                        @else
                                           Tidak Ada File
                                    ...
                                    <td><a data-toggle="modal" data-target="#modalforum{{$value->id}}" class="btn btn-danger">DELETE <i class="fas fa-trash"></i></a></td>
                                    <div class="modal fade" id="modalforum{{$value->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Are you Sure?</h5>
                                                ...
                                                <div class="modal-footer">
                                                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                                                    <a class="btn btn-primary" href="{{secure_url('/del_pkm/forum')}}/{{$data->id}}/{{$value->id}}">YES</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="ml-4 mt-3">
                    <p>Media Massa :
                        &nbsp
                        <a href="{{secure_url('/pkm/luaran/media')}}/<?php echo $data->id ?>">EDIT &nbsp<i class="fas fa-pencil-alt fa-sm text-white-10"></i></a>
                    </p>
                    <div class="table-responsive">
                        <table class="table table-border">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($luaran['media_massa'][$key]->bukti !=NULL)
                                            <a href="{{secure_url('/media_down')}}/{{$value->id}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                                                <i class="fas fa-download fa-sm text-white-50"></i>
                                            Download</a>
                                            <a href="{{secure_url('/media_file/')}}" class="d-none  target="_blank"d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                                                <i class="fas fa-eye fa-sm text-white-50"></i>
                                            Show</a>
                                        @else
                                           Tidak Ada File
                                    ...
                                    <div class="modal fade" id="modalalm<?php echo $luaran['media_massa'][$key]->id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                                                    <a class="btn btn-primary" href="{{secure_url('/del_pkm/media')}}/{{$data->id}}/<?php echo $luaran['media_massa'][$key]->id ?>">YES</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="ml-4 mt-3">
                    <p>Wirausaha Baru Mandiri :
                        &nbsp
                        <a href="{{secure_url('/pkm/luaran/wbm')}}/<?php echo $data->id ?>">EDIT &nbsp<i class="fas fa-pencil-alt fa-sm text-white-10"></i></a>
                    </p>
                    <div class="table-responsive">
                        <table class="table table-border">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($luaran['wbm'][$key]->bukti !=NULL)
                                            <a href="{{secure_url('/wbm_down')}}/{{$value->id}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                                                <i class="fas fa-download fa-sm text-white-50"></i>
                                            Download</a>
                                            <a href="{{secure_url('/wbm_file')}}/{{$value->id}}" cl target="_blank"ass="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                                                <i class="fas fa-eye fa-sm text-white-50"></i>
                                            Show</a>
                                        @else
                                           Tidak Ada File
                                    ...
                                    <div class="modal fade" id="modalwbm<?php echo $luaran['wbm'][$key]->id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                                                    <a class="btn btn-primary" href="{{secure_url('/del_pkm/wbm')}}/{{$data->id}}/<?php echo $luaran['wbm'][$key]->id ?>">YES</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="ml-4 mt-3">
                    <p><b>Jurnal Intrernasional :</b> 
                        &nbsp
                        <a href="{{secure_url('/pkm/luaran/jurnal')}}/<?php echo $data->id ?>">EDIT &nbsp<i class="fas fa-pencil-alt fa-sm text-white-10"></i></a>
                    </p>
                    <div class="table-responsive">
                        <table class="table table-border">
                            <thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @if($luaran['jurnal_internasional'][$key]->bukti !=NULL)
                                        <a href="{{secure_url('/jurnal_down')}}/{{$value->id}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                                            <i class="fas fa-download fa-sm text-white-50"></i>
                                        Download</a>
                                        <a href="{{secure_url('/jurnal_file')}}/{{$value->id}}" target="_blank" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                                            <i class="fas fa-eye fa-sm text-white-50"></i>
                                        Show</a>
                                    @else
                                        Tidak Ada File
                                    ...
                                    <div class="modal fade" id="modaljurnal<?php echo $luaran['jurnal_internasional'][$key]->id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                                                    <a class="btn btn-primary" href="{{secure_url('/del_pkm/jurnal')}}/{{$data->id}}/<?php echo $luaran['jurnal_internasional'][$key]->id ?>">YES</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
