...
<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Luaran Produk Terstandarisasi</h1>

    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <form action="{{secure_url('/editpkm/luaran/prodstan')}}/{{$id}}" method="post" enctype="multipart/form-data">
            @csrf
