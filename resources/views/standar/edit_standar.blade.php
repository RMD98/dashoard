...
<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Edit Standar Pengabdian Kepada Masyarakat (PKM)</h1>

    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <form action="{{secure_url('/edt_standar')}}/<?php echo $data->id?>" method="post">
            @csrf
            <div class="form-group row">
                ...
                <div class="col-sm-6 mb-3 mb-sm-0 ml-2">
                    <p><b>Nomor</b>
                        <input type="number" class="form-control" value="<?php echo $data->Nomor ?>"id="nomor" name="nomor"
                        placeholder="Nomor">
                    </p>
                </div>
                <div class="col-sm-6 mb-3 mb-sm-0 ml-2">
